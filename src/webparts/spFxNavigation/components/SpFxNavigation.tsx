...
export default class SpFxNavigation extends React.Component<
          ...
          <StackItem align="auto" styles={stackfooterStyles}>
            <Switch>
              ...
              <Route
                exact
                path="/Requests"
                render={() => <Request {...this.props} />}
              />
              <Route
                exact
                strict
                path="/contracts"
                render={() => <Contracts {...this.props} />}
              />
              <Route
                exact
                path="/Reports"
                render={() => <Reports {...this.props} />}
              />
              <Route
                exact
                strict
              ...
              <Route
                ...
                render={() => <CustomNavigation {...this.props} />}
              />
